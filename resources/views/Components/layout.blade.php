...
<!-- Mirrored from html.themewant.com/studyhub/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Sep 2024 03:28:02 GMT -->
...
<body>
                                        ...
                                        <ul class="submenu">
                                            ...
                                            <li class="sub-dropdown">
                                                ...
                                                <ul class="submenu third-lvl base">
                                                    <li><a class="mobile-menu-link" href="zoom-meeting.html">Zoom
                                                            Meeting</a></li>
                                                    <li><a class="mobile-menu-link" href="zoom-details.html">Zoom
                                                            Details</a></li>
                                                </ul>
                                            </li>
                                            <li class="sub-dropdown">
                                                ...
                                                <ul class="submenu third-lvl base">
                                                    ...
                                                    <li><a class="mobile-menu-link" href="event-2.html">Event Two</a>
                                                    </li>
                                                    <li><a class="mobile-menu-link" href="event-details.html">Event
                                                            Details</a></li>
                                                </ul>
                                            </li>
                                            <li class="sub-dropdown">
                                                ...
                                                <ul class="submenu third-lvl base">
                                                    ...
                                                    <li><a class="mobile-menu-link" href="product-details.html">Product
                                                            Details</a></li>
                                                    <li><a class="mobile-menu-link" href="checkout.html">Checkout</a>
                                                    </li>
                                        ...
                                        <ul class="submenu">
                                            <li class="sub-dropdown">
                                                <a class="submenu-link" href="javascript:void(0);">Instructor
                                                    Dashboard</a>
                                                <ul class="submenu third-lvl base">
                                                    <li><a class="mobile-menu-link" href="dashboard.html">Dashboard</a>
                                                    </li>
                                                    <li><a class="mobile-menu-link" href="my-profile.html">My
                                                            Profile</a></li>
                                                    <li><a class="mobile-menu-link" href="enroll-course.html">Enroll
                                                            Course</a></li>
                                                    <li><a class="mobile-menu-link" href="wishlist.html">Wishlist</a>
                                                    </li>
                                                    ...
                                                    <li><a class="mobile-menu-link" href="order-history.html">Order
                                                            History</a></li>
                                                    <li><a class="mobile-menu-link" href="question-answer.html">Question
                                                            Answer</a></li>
                                                    <li><a class="mobile-menu-link" href="calender.html">Calender</a>
                                                    </li>
                                                    <li><a class="mobile-menu-link" href="my-course.html">My Course</a>
                                                    </li>
                                                    <li><a class="mobile-menu-link"
                                            ...
                                            <li class="sub-dropdown">
                                                ...
                                                <ul class="submenu third-lvl base">
                                                    ...
                                                    <li><a class="mobile-menu-link"
                                                            href="student-quick-attempts.html">Quick Attempts</a></li>
                                                    <li><a class="mobile-menu-link"
                                                            href="student-order-history.html">Order History</a></li>
                                                    <li><a class="mobile-menu-link"
                                                            href="student-question-answer.html">Question Answer</a></li>
                                                    <li><a class="mobile-menu-link"
                                                            href="student-calender.html">Calender</a></li>
                                                    <li><a class="mobile-menu-link" href="student-settings.html">Student
                                                            Settings</a></li>
                                                </ul>
                                            </li>
                                        </ul>
    ...
    <div class="banner-area-one shape-move">
        ...
        <div class="shape-image">
            <div class="shape one" data-speed="0.04" data-revert="true"><img
                    src="assets/images/banner/shape/banner-shape01.svg" alt="shape_image"></div>
            <div class="shape two" data-speed="0.04"><img src="assets/images/banner/shape/banner-shape02.svg"
                    alt="shape_image"></div>
            <div class="shape three" data-speed="0.04"><img src="assets/images/banner/shape/banner-shape03.svg"
                    alt="shape_image"></div>
        </div>
    </div>
    <!-- banner area end -->
    ...
    <div class="category-area-style-one shape-move rts-section-gap bg_image">
        ...
        <div class="shape-image">
            <div class="shape one" data-speed="0.04" data-revert="true"><img src="assets/images/banner/15.png" alt="">
            </div>
            <div class="shape two" data-speed="0.04"><img src="assets/images/banner/shape/banner-shape02.svg" alt="">
            </div>
            <div class="shape three" data-speed="0.04"><img src="assets/images/banner/shape/banner-shape03.svg" alt="">
            </div>
        </div>
    </div>
    <!-- category area end -->
            ...
            <div class="ms-portfolio-filter-area main-isotop">
                <div class="portfolio_wrap">
                    <div class="filter row g-5 mt--20 portfolio-feed personal">
                        <div class="flash grid-item-p element-item transition creative col-xl-3 col-lg-4 col-md-6 col-sm-6"
                        ...
                        <div class="flash grid-item-p element-item transition design col-xl-3 col-lg-4 col-md-6 col-sm-6"
                            data-category="transition">
                            <!-- rts single course -->
                            <div class="rts-single-course">
                                <a href="single-course.html" class="thumbnail">
                        ...
                        <div class="flash grid-item-p element-item transition photo col-xl-3 col-lg-4 col-md-6 col-sm-6"
                            data-category="transition">
                            <!-- rts single course -->
                            <div class="rts-single-course">
                                <a href="single-course.html" class="thumbnail">
                        ...
                        <div class="flash grid-item-p element-item transition style col-xl-3 col-lg-4 col-md-6 col-sm-6"
                            data-category="transition">
                            <!-- rts single course -->
                            <div class="rts-single-course">
                                <a href="single-course.html" class="thumbnail">
    ...
    <div class="why-choose-us bg-blue bg-choose-us-one bg_image rts-section-gap shape-move">
        ...
        <div class="shape-image">
            ...
            <div class="shape two" data-speed="0.04"><img src="assets/images/banner/shape/banner-shape02-w.svg" alt="">
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="upcoming-events-main-wrapper-1">
                        ...
                        <div class="single-upcoming-events">
                            ...
                            <a href="event-details.html" class="rts-btn btn-primary with-arrow">Get Ticket <i
            ...
            <div class="row mt--50">
                <div class="col-lg-12">
                    <div class="students-feedback-wrapper-1 bg_image">
                        ...
                        <div class="shape-image">
                            <div class="shape one" data-speed="0.04" data-revert="true"><img
                                    src="assets/images/banner/18.png" alt=""></div>
                            <div class="shape three" data-speed="0.04"><img src="assets/images/banner/17.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from html.themewant.com/studyhub/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Sep 2024 03:30:28 GMT -->
